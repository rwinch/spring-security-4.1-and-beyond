...
angular.module('controller.message', [
	...
	'secure-messaging-app.message-resource',
	'ngAnimate',
	'ui.bootstrap'
])

.controller('messageController', ['$scope', 'MessageEndpoint', 'PlatformVersionProfileEndpoint', 'AppConfigEndpoint', 'AppConfigRestore', 'AppConfigBackup', '$uibModal', 'errorService', function ($scope, MessageEndpoint, PlatformVersionProfileEndpoint, AppConfigEndpoint, AppConfigRestore, AppConfigBackup, $uibModal, errorService) {
	...
	$scope.getInboxMessages = function() {
		MessageEndpoint.inbox.query().$promise.then(function(data) {
			$scope.inboxMessages = data._embedded.messages;
		});
	};
