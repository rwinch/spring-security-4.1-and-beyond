...
insert into user(id,email,password,first_name,last_name) values (3,'joe@example.com','password','Joe','Grandja');
...
insert into message(id,created,to_id,from_id,summary,text) values (102,'2014-07-12 23:00:00',0,3,'Hey Rob?','This message is for Rob');
...
insert into message(id,created,to_id,from_id,summary,text) values (130,'2014-07-12 10:00:00',3,0,'Hello Joe','This message is for Joe');
insert into message(id,created,to_id,from_id,summary,text) values (131,'2014-07-12 14:00:00',3,1,'How are you Joe?','This message is for Joe');
insert into message(id,created,to_id,from_id,summary,text) values (132,'2014-07-12 22:00:00',3,0,'Is this secure?','This message is for Joe');
